...
def compute_metrics(reference_file: str, prediction_file: str, image_reader_writer: BaseReaderWriter,
    ...
    # Get spacing from the image properties dictionary and calculate voxel volume in mm^3
    ...
    for r in labels_or_regions:
        ...
        # Add the volume-based metrics
        results['metrics'][r]['FPvol'] = fp * voxel_volume
        results['metrics'][r]['FNvol'] = fn * voxel_volume
